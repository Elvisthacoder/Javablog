...
public class InvalidColumnNameException extends BaseSQLException
{
	...
	/**
     * Constructs a new InvalidColumnNameException exception with null as its detail 
    ...
    /**
     * Constructs a new InvalidColumnNameException exception with the specified detail 
     * message. The cause is not initialized, and may subsequently be 
     * initialized by a call to Throwable.initCause(java.lang.Throwable). 
     * 
    ...
    /**
     * Constructs a new InvalidColumnNameException exception with the 
     * specified cause. 
     * 
    ...
    /**
     * Constructs a new InvalidColumnNameException exception with the specified 
