...
String resource = "vrecords";
String[] parentResourceNames = {"databases", "views"};
String[] parentRestfuls = {database, view};
...
<h3><%=T.pluralize(recordsCount, "record")%> in View <%=view%></h3>
